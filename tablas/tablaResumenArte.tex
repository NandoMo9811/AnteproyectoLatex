
{
    ...
    \begin{longtable}{c p{3cm} p{3cm} p{3cm} p{3cm}}
        ...
        \cite{FoulonneauCalvaryVillain2016} & TILT & Aplicación persuasiva con automonitoreo y mensajes adaptativos según contexto & Reducción sostenida del tiempo de uso mediante persuasión contextual & Enfoque centrado en control conductual, no en nomofobia \\
